...
export function SplashScreen() {
  return (
    <div
      ...
      role="status"
      aria-label="Loading BIT KMC Question Bank"
    >
      <div
      ...
      <div className="mt-6 text-center animate-in fade-in slide-in-from-bottom-2 duration-700">
        <h1 className="text-lg font-bold">BIT KMC Question Bank</h1>
        <p className="text-xs text-muted-foreground mt-1">Kailali Multiple Campus</p>
      </div>
